...
SetupWidget::SetupWidget(QWidget* parent) : QFrame(parent) {
  ...
  QLabel* registrationTitle = new QLabel("\U0001f680 FEATURE \U0001f680");
  ...
  QLabel* registrationDescription = new QLabel("1.Dynamic Lane Profile\n (토글>Kale모드 활성화)\n2.Lateral Control Select\n (PID-d gain,LQR,INDI)\n3.auto engage(5km)\n4.ascc auto set(30km)");
  registrationDescription->setWordWrap(true);
  registrationDescription->setStyleSheet("font-size: 40px; font-weight: light; margin-left: 110px;");
